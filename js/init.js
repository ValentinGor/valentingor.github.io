/*
 * Copyright (c) 2019 Valentin Gorbatenko
...
function vg_tm_text_animation() {
    ...
    var titleHolder2 = jQuery('.vg_tm_universal_box_wrap .hero_info');
    ...
    jQuery(window).on('scroll', function () {
        ...
        titleHolder2.css({opacity: 1 - (window_offset / height), marginTop: (window_offset / height) * 200});
    });
}
